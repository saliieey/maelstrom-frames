          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            {stats.map((stat, i) => (
              <div
                ...
                className="group relative text-center p-5 sm:p-6 md:p-8 bg-gradient-to-br from-white to-warm-50/50 rounded-2xl border border-gray-100 hover:border-warm-200 transition-all duration-500 hover:shadow-xl hover:-translate-y-2 overflow-hidden"
              >
                {/* Decorative Element */}
